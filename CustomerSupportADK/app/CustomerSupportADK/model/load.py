...
IDENTITY_PROVIDER_NAME = "GOOGLE_API_KEY"  # Example provider, replace with your actual provider name
IDENTITY_ENV_VAR = "GOOGLE_API_KEY"  # The environment variable where the API key will be stored for the ADK to use
